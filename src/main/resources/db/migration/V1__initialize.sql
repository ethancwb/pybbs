...
VALUES
	...
	(2, 'base_url', 'http://localhost:8088/kaopu', '网站部署后访问的域名，注意这个后面没有 \"/\"', 23, 'url', NULL, 0),
	...
	(18, 'static_url', '/kaopu/static/', '静态文件访问地址，主要用于上传图片的访问，注意最后有个\"/\"', 25, 'url', NULL, 0),
	(20, 'upload_avatar_size_limit', '2', '上传头像文件大小，单位MB，默认2MB', 25, 'number', NULL, 0),
	(21, 'upload_path', '/kaopu/static/upload/', '上传文件的路径，注意最后有个\"/\"', 25, 'text', NULL, 0),
...
VALUES
    (0, '求职', '求职相关话题', '2018-11-11 11:11:11'),
