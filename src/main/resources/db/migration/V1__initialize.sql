...
VALUES
	...
	(2, 'base_url', 'http://localhost:8088', '网站部署后访问的域名，注意这个后面没有 \"/\"', 23, 'url', NULL, 0),
	...
	(11, 'intro', '<h5>靠谱的人注意啦</h5><p>在这里，您可以提问，回答，分享，诉说，这是个只属于靠谱用户的社区，欢迎您的加入！</p>', '站点介绍', 23, 'text', NULL, 0),
	(15, 'name', '靠谱社区', '站点名称', 23, 'text', NULL, 0),
	...
	(18, 'static_url', 'http://localhost:8088/static/upload/', '静态文件访问地址，主要用于上传图片的访问，注意最后有个\"/\"', 25, 'url', NULL, 0),
	(20, 'upload_avatar_size_limit', '2', '上传头像文件大小，单位MB，默认2MB', 25, 'number', NULL, 0),
	(21, 'upload_path', 'http://localhost:8088/static/upload/', '上传文件的路径，注意最后有个\"/\"', 25, 'text', NULL, 0),
...
INSERT INTO `tag` (`id`, `name`, `description`, `in_time`)
VALUES
    (0, '工作', '工作相关话题', '2018-11-11 11:11:11'),
    (1, '同城', '同城相关话题', '2018-11-11 11:11:11'),
    (2, '学校', '学校相关话题', '2018-11-11 11:11:11'),
    (3, '学术', '学术相关话题', '2018-11-11 11:11:11'),
    (4, '爱好', '爱好相关话题', '2018-11-11 11:11:11'),
    (5, '管理', '管理相关话题', '2018-11-11 11:11:11'),
    (6, '其他', '其他相关话题', '2018-11-11 11:11:11');
